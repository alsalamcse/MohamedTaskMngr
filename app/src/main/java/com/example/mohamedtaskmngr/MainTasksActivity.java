...
import com.example.mohamedtaskmngr.ui.main.MyFragmentsPagerAdapter;
...
public class MainTasksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_tasks_acticity);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i=new Intent(getApplication(), addTask.class);
                startActivity(i);
            }
        });
    }
